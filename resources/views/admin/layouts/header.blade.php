        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                ...
                <li
                    ...
                    >
                    <a
                        class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white text-black"
                        href="#"
                            ...
                            <li>
                                <a
                                    ...
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{asset('library/images/user/user-02.png')}}" alt="User" />
                                    </div>
                                    <div>
            ...
            <div
                ...
                <a
                    ...
                    <span class="h-12 w-12 rounded-full">
                        ...
                        @else
                            <img src="{{ asset('library/images/user/user-01.png') }}" alt="User" />
                        @endif
                    </span>
                    <svg
