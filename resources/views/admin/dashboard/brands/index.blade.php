...
@section('content')
    <div class="container mx-auto px-2 py-8 sm:px-6 md:px-8">
        <h3 class="text-xl font-bold">NHÃN HÀNG</h3>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-xs font-medium text-gray-500 uppercase tracking-wider text-left">Tên Nhãn Hàng</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 text-sm	">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-2 whitespace-nowrap text-center">
                                ...
                                <a href="{{route('admin.brands.delete', $brand->id)}}" class="inline-flex items-center text-red-600 hover:text-red-900">
            ...
            <div class="px-4 py-6 md:px-6 xl:px-7.5">
                {{$brands->links('admin.layouts.custom-pagination')}}
            </div>
