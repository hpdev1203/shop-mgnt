<div>
    <form wire:submit='updatePaymentMethod'>
                ...
                <div class="grid gap-x-6 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-6">
                    ...
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        <div class="mt-2 inline">
                                <input type="checkbox" @checked(old('active', $payment_method_active)) class="cursor-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" wire:model="payment_method_active" name="payment_method_active" id="payment_method_active" value="1">
                        </div>
                    ...
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        <div class="mt-2 inline">
                                <input type="checkbox" @checked(old('active', $payment_method_default))  class="cursor-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" wire:model="payment_method_default" name="payment_method_default" id="payment_method_default" value="1">
                        </div>
