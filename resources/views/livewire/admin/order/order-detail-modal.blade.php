<div>
    ...
    <!-- Modal body -->
    <form class="p-4 md:p-5" wire:submit="storeOrderProduct">
        <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sản phẩm</label>
                <div class="mt-2">
                    <select id="product_id" wire:model="product_id" name="product_id" wire:change="loadProductDetails()" class="convert-to-dropdown block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        <option value="">-</option>
            ...
            <div class="col-span-1">
                ...
                <div class="mt-2">
                    <input wire:model="product_quantity" name="product_quantity" id="product_quantity" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-right">
                </div>
            </div>
