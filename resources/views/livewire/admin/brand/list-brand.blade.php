            ...
            <tbody class="bg-white divide-y divide-gray-200 text-sm	">
                ...
                <tr>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-center">
                        ...
                        <a data-modal-target="static-modal" data-modal-toggle="static-modal" onclick="parseDataDelete('{{$brand->id}}', '{{$brand->name}}')" class="inline-flex items-center text-red-600 hover:text-red-900 cursor-pointer">
