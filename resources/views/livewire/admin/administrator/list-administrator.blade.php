        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 text-xs font-medium text-gray-500 uppercase tracking-wider text-left">Hoạt động</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200 text-sm	">
                ...
                <tr>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-center">
                        ...
                        <a data-modal-target="static-modal" data-modal-toggle="static-modal" onclick="parseDataDelete('{{$administrator->id}}', '{{$administrator->name}}')" class="cursor-pointer inline-flex items-center text-red-600 hover:text-red-900">
