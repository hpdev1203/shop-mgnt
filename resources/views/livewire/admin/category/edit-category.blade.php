            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid gap-x-6 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-6">
                    ...
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        ...
                        <div class="mt-2">
                            <select wire:model="parent_category_id" id="parent_cate_id" name="parent_cate_id" autocomplete="parent_cate_id" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                <option value="">-</option>
