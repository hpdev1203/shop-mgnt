            ...
            <tbody class="bg-white divide-y divide-gray-200 text-sm	">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 whitespace-nowrap text-center">
                        ...
                        <a data-modal-target="static-modal" data-modal-toggle="static-modal" onclick="parseDataDelete('{{$category->id}}', '{{$category->name}}')" class="inline-flex items-center text-red-600 hover:text-red-900">
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button id="btn-delete-category" wire:click='' data-modal-hide="static-modal" href="" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Xóa</button>
