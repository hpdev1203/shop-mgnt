            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid gap-x-6 gap-y-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                    ...
                    <div style="{{ $styleDate }}" class="col-span-1 sm:col-span-2 md:col-span-1">
                        <label for="start_date" class="block text-sm font-medium leading-6 text-gray-900">Ngày kết thúc</label>
                        <div class="mt-2">
                            <input wire:model="end_date" type="date" name="start_date" id="start_date" autocomplete="start_date" class="block w-full rounded-md bstart-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                        @error('start_date')
                    ...
                    <div style="{{ $styleDate }}" class="col-span-1 sm:col-span-2 md:col-span-1">
                        <label for="end_date" class="block text-sm font-medium leading-6 text-gray-900">Ngày đặt hàng <span class="text-red-700">*</span></label>
                        <div class="mt-2">
