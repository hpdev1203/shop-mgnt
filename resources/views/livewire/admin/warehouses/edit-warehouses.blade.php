<div>
    <form wire:submit='updateWarehouses'>
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid gap-x-6 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-6">
                    ...
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        ...
                        <div class="mt-2">
                            <textarea wire:model="warehouses_address" id="warehouses_address" name="warehouses_address" autocomplete="warehouses_phone"  rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                        </div>
                    </div>
                    <div class="col-span-1 sm:col-span-2 md:col-span-2"></div>
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
