...
class Cart extends Component
{
    ...
    function load(){
        ...
        if($this->Carts != null){
            ...
            SELECT crt.product_id,SUM(crt.total_amount) as total,prd_dt.title as dt_name,crt.product_id as id,prd.slug,crt.cart_id, prd.name,sum(crt.quantity) as qty,prd_dt.retail_price
            FROM cart_item crt
            ...
            GROUP BY crt.product_id,prd_dt.title,prd.slug,crt.cart_id, prd.name,prd_dt.retail_price ');
        }
